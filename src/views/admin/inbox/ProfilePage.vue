        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between">
          <div class="d-flex flex-wrap align-items-center">
            <div class="profile-img position-relative me-3 mb-3 mb-lg-0 profile-logo profile-logo1">
              ...
              <img src="@/assets/images/avatars/01.png" alt="User-Profile" class="theme-color-purple-img img-fluid rounded-pill avatar-100" loading="lazy" />
              <img src="@/assets/images/avatars/02.png" alt="User-Profile" class="theme-color-blue-img img-fluid rounded-pill avatar-100" loading="lazy" />
              <img src="@/assets/images/avatars/04.png" alt="User-Profile" class="theme-color-green-img img-fluid rounded-pill avatar-100" loading="lazy" />
              <img src="@/assets/images/avatars/05.png" alt="User-Profile" class="theme-color-yellow-img img-fluid rounded-pill avatar-100" loading="lazy" />
              <img src="@/assets/images/avatars/03.png" alt="User-Profile" class="theme-color-pink-img img-fluid rounded-pill avatar-100" loading="lazy" />
            </div>
    ...
    <b-col lg="6">
      <div class="profile-content tab-content iq-tab-fade-up">
        ...
        <div id="profile-profile" class="tab-pane fade">
          <profile-widget name="Austin Robertson" date="Feb 15, 2021" location="United States of America" email="austin@gmail.com" url="www.bootstrap.com" number="(001) 4544 565 456" />
        </div>
      </div>
    </b-col>
    <b-col lg="3">
