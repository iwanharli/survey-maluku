  ...
  <b-row>
    <b-col xl="5" lg="5" md="12" sm="12" class="custom-mobile">
      ...
      <b-card>
        <div class="card-header d-flex justify-content-between">
          <div class="header-title">
            <h4 class="card-title" style="font-weight: bold; font-size: 20px">STATUS <span style="color: red">*</span></h4>
          </div>
        </div>
        <hr />
        <div class="card-body" style="font-weight: bold">
          <b-row>
            <b-col md="6" class="form-group text-dark">
              <label class="form-label">Pendidikan:</label>
              <select name="type" class="selectpicker form-control" v-model="selectedPendidikan">
                <option value="">- Pilih -</option>
                <option value="sd">SD</option>
                <option value="smp">SMP</option>
                <option value="sma/smk">SMA/SMK</option>
                <option value="diploma">Diploma</option>
                <option value="s1+">S1 ke Atas</option>
                <option value="lainnya">Lainnya</option>
              </select>
            </b-col>
            <b-col md="6" class="form-group text-dark">
              <label class="form-label">Pekerjaan</label>
              <select name="type" class="selectpicker form-control" v-model="selectedPekerjaan">
                <option value="">- Pilih -</option>
...
export default {
  ...
  methods: {
    ...
    async submitSurvey() {
      ...
      formData.append('education', this.selectedPendidikan)
      formData.append('job', this.selectedPekerjaan)
      ...
      await axios
        .post('/api/survey/submit/2', formData, config)
        .then((response) => {
          // console.clear()
