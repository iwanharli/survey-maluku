<template>
  <b-row>
        ...
        <div class="card-body" style="font-weight: bold">
          <b-row>
            ...
            <b-col md="12" class="form-group mt-2">
              <label class="form-label text-dark">No HP: </label> <span style="font-weight: 100"> (optional) </span>
    ...
    <b-col xl="7" lg="7" md="12" sm="12">
      <div class="card-header bg-primary d-flex justify-content-between mt-4 mb-4" style="padding: 20px; border-radius: 20px; border: 5px solid rgb(255, 255, 255)">
        <div class="header-title">
        ...
        .then((response) => {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              window.location.href = '/responden-survey'
            } else if (result.dismiss === Swal.DismissReason.cancel) {
              window.location.href = '/input-survey-jogja'
            }
          })
        })
        .catch((error) => {
