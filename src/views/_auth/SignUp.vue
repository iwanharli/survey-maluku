        ...
        <div class="row justify-content-center">
          <div class="col-md-10">
            <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
              <div class="card-body">
                <router-link :to="{ name: 'auth.login' }" class="navbar-brand d-flex align-items-center mb-3 text-primary">
                  <brand-logo></brand-logo>
                  <h4 class="logo-title ms-3 mb-0" data-setting="app_name">PAPANJALU</h4>
                </router-link>
                <br />
                <br />
                <br />
                <h2 class="mb-2 text-center mb-5">DAFTAR</h2>
                <form>
                  <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label for="last-name" class="form-label">No HP</label>
                  ...
                  <p class="mt-3 text-center">Already have an Account? <a href="/login" class="text-underline">Log in</a></p>
                </form>
              </div>
            </div>
          </div>
