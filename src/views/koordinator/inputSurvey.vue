<template>
  <b-row>
    ...
    <b-col xl="7" lg="7" md="12" sm="12">
      ...
      <hr />
      <div v-for="item in surveyQuestionData" :key="item.id">
        <b-card>
          <div class="d-flex align-items-center justify-content-between">
            <b-row>
              <b-col xl="1" lg="1" md="1" sm="1">
                <h6 :class="`mb-0`" style="text-transform: capitalize; font-weight: bolder">{{ item.id }}</h6>
              </b-col>
  ...
  methods: {
    ...
    async showSurveyQuestion() {
      ...
      try {
        ...
        console.log('💚 Data Question ', id, ' fetched')
      } catch (error) {
