<template>
  ...
  <default-sidebar>
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
      ...
      <side-menu isTag="router-link" title="DASHBOARD" icon="view-grid" :route="{ to: 'koordinator.dashboard' }" style="font-weight: bolder"></side-menu>

      <br />
      <br />
      <li><hr class="hr-horizontal" /></li>
      <side-menu title="LAPOR" :static-item="true" miniTitle=""></side-menu>
      <side-menu isTag="router-link" title="SUBMIT ISU" icon="square-plus" :icon-size="15" icon-type="solid" miniTitle="+" :route="{ to: 'koordinator.input-issue' }"></side-menu>
      <side-menu isTag="router-link" title="SUBMIT SURVEY" icon="file" :icon-size="15" icon-type="solid" miniTitle="IS" :route="{ to: 'koordinator.input-survey' }"></side-menu>
    </ul>
  </default-sidebar>
